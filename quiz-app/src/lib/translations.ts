...
export const translations: Record<Language, Translations> = {
    en: {
        ...
        tutorialStep5: "Phase 2: Still not sure? The 1st caricature is revealed. Guess correctly here for 2 Points!",
        tutorialStep6: "Phase 3: The final clue! The 2nd caricature is revealed. Guess correctly here for 1 Point!",
    ...
    hu: {
        ...
        tutorialStep5: "2. fázis: Még mindig nem tudod? Feltűnik az 1. karikatúra. Helyes válasz esetén 2 pont jár!",
        tutorialStep6: "3. fázis: Az utolsó nyom! Jön a 2. karikatúra. Helyes válasz esetén itt már csak 1 pont jár!",
    ...
    ua: {
        ...
        tutorialStep5: "Фаза 2: Все ще не впевнені? З'являється 1-ша карикатура. За правильну здогадку тут ви отримаєте 2 бали!",
        tutorialStep6: "Фаза 3: Остання підказка! З'являється 2-га карикатура. За правильну відповідь тут ви отримаєте 1 бал!",
    ...
    ru: {
        ...
        tutorialStep3: "Затем с помощью ИИ мы создали симпатичные карикатури по этим словам! Ваша задача - угадать, кто на этих изображениях.",
        tutorialStep4: "Фаза 1: Появляются слова, описывающие женщину. Правильный ответ здесь стоит 3 балла!",
        tutorialStep5: "Фаза 2: Все еще не уверены? Появляется 1-я карикатура. Правильный ответ здесь стоит 2 балла!",
        tutorialStep6: "Фаза 3: Последняя подсказка! Появляется 2-я карикатура. За правильную догадку здесь вы получите 1 балл!",
