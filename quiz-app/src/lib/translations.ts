...
export const translations: Record<Language, Translations> = {
    en: {
        ...
        tutorialStep3: "Then, we used an AI image generator to create sympathetic AI portraits based on those words! Your job is to try and guess who from you is on those images.",
        tutorialStep4: "Phase 1: Common words describing the woman are revealed. Lock in your guess for 3 Points!",
        tutorialStep5: "Phase 2: Still not sure? The 1st AI portrait is revealed. Guess correctly here for 2 Points!",
        tutorialStep6: "Phase 3: The final clue! The 2nd AI portrait is revealed. Guess correctly here for 1 Point!",
        tutorialStep7: "Let's try a demo! Who is this?",
        tutorialNext: "Next",
        tutorialStart: "Start Tutorial",
        imReady: "I'm Ready! 🚀",
        ready: "Ready",
        tutorialDemoOptionA: "Kostya",
        tutorialDemoOptionB: "Obi Wan",
    ...
    hu: {
        ...
        tutorialStep3: "Majd ezekből a szavakból egy AI segítségével jópofa AI portrékat generáltunk! A feladatod az, hogy kitaláld, ki van a képeken.",
        tutorialStep4: "1. fázis: Megjelennek a hölgyet jellemző szavak. Ha ezen a ponton eltalálod, az 3 pontot ér!",
        tutorialStep5: "2. fázis: Még mindig nem tudod? Feltűnik az 1. AI portré. Helyes válasz esetén 2 pont jár!",
        tutorialStep6: "3. fázis: Az utolsó nyom! Jön a 2. AI portré. Helyes válasz esetén itt már csak 1 pont jár!",
    ...
    ua: {
        ...
        tutorialStep3: "Потім за допомогою штучного інтелекту ми створили симпатичні ШІ-портрети з цих слів! Ваше завдання - відгадати, хто зображений на цих зображеннях.",
        tutorialStep4: "Фаза 1: З'являються слова, що описують жінку. Ваша правильна відповідь тут принесе 3 бали!",
        tutorialStep5: "Фаза 2: Все ще не впевнені? З'являється 1-й ШІ-портрет. За правильну здогадку тут ви отримаєте 2 бали!",
        tutorialStep6: "Фаза 3: Остання підказка! З'являється 2-й ШІ-портрет. За правильну відповідь тут ви отримаєте 1 бал!",
    ...
    ru: {
        ...
        tutorialStep3: "Затем с помощью ИИ мы создали симпатичные ИИ-портреты по этим словам! Ваша задача - угадать, кто на этих изображениях.",
        tutorialStep4: "Фаза 1: Появляются слова, описывающие женщину. Правильный ответ здесь стоит 3 балла!",
        tutorialStep5: "Фаза 2: Все еще не уверены? Появляется 1-й ИИ-портрет. Правильный ответ здесь стоит 2 балла!",
        tutorialStep6: "Фаза 3: Последняя подсказка! Появляется 2-й ИИ-портрет. За правильную догадку здесь вы получите 1 балл!",
