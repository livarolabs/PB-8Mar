...
export const translations: Record<Language, Translations> = {
    en: {
        ...
        tutorialStep4: "Phase 1: The 1st caricature is revealed on the TV. Lock in your guess for 2 Points!",
        tutorialStep5: "Phase 2: Still not sure? The 2nd caricature is revealed. Guess correctly here for 1 Point!",
        tutorialStep6: "The best guesser with the most points at the end WINS! 🏆",
    ...
    hu: {
        ...
        tutorialStep4: "1. fázis: A TV-n feltűnik az 1. karikatúra. Ha ezen a ponton eltalálod telefonodon, az 2 pontot ér!",
        tutorialStep5: "2. fázis: Még mindig nem tudod? Jön a 2. karikatúra. Helyes válasz esetén 1 pont jár!",
        tutorialStep6: "A legtöbb pontot gyűjtő tippelő NYER! 🏆",
    ...
    ua: {
        ...
        tutorialStep4: "Фаза 1: З'явиться 1-ша карикатура. Ваша правильна відповідь тут принесе 2 бали!",
        tutorialStep5: "Фаза 2: Все ще не впевнені? З'являється 2-га карикатура. За правильну здогадку тут ви отримаєте 1 бал!",
        tutorialStep6: "Перемагає той, хто набере найбільше балів! 🏆",
    ...
    ru: {
        ...
        tutorialStep4: "Фаза 1: Появится 1-я карикатура. Правильный ответ здесь стоит 2 балла!",
        tutorialStep5: "Фаза 2: Все еще не уверены? Появляется 2-я карикатура. За правильную догадку здесь вы получите 1 балл!",
        tutorialStep6: "Победит набравший наибольшее количество баллов! 🏆",
